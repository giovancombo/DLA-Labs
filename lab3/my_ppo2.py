...
# A second Off-the-Shelf implementation of the Proximal Policy Optimization algorithm
...
def train_ppo2(env, agent, N, n_games, wandb_log):
    figure_file = f'images/{env.unwrapped.spec.id}_myppo2.png'
